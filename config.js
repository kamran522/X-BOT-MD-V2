...
const SUDO = process.env.SUDO || '923395267262';
...
const BOT_INFO = process.env.BOT_INFO || "X-BOT-MD;BALOCH HACKER;https://imgur.com/a/ubj9eN7";
const URL = process.env.URL || "https://www.instagram.com/Kamran_.hasil";
const AUDIO_DATA = process.env.AUDIO_DATA || "X BOT MD;BALOCH HACKERS;https://imgur.com/a/ubj9eN7";
const STICKER_DATA = process.env.STICKER_DATA || "X BOT MD;BALOCH HACKERS";
