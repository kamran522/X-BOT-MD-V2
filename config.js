...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:d68902d1bc8234c6bbc0e166ea8c4143";
const SUDO = process.env.SUDO || '923323963788';
...
const BOT_INFO = process.env.BOT_INFO || "X-BOT-MD;K A M I;https://i.imgur.com/bZUQlHI.jpeg";
const URL = process.env.URL || "https://www.instagram.com/kamran_.hasil";
const AUDIO_DATA = process.env.AUDIO_DATA || "X BOT MD;K A M I;https://i.imgur.com/bZUQlHI.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "X BOT MD;K A M I";
